...
def plothistdiameter(trainpath='/DeepLung-master/preprocessing/newtrain/', 
                     testpath='/DeepLung-master/preprocessing/newtest/'):
    diameterlist = []
...
def getrecall(path='/DeepLung-master/CTnoddetector/training/detector/results/res18/baselinebboxlranchorftbig/test55test/'):
...
def getrecallwrtdetp(path='/DeepLung-master/CTnoddetector/training/detector/results/res18/baselinebboxlranchorftbig96/test64/'):
    thresh = np.linspace(-7, 0, 8)
    import pandas as pd
    import math
    gtcolname = ['seriesuid', 'coordX', 'coordY', 'coordZ', 'diameter_mm']
    annogt = pd.read_csv('/DeepLung-master/csv/newtest/annotations.csv', names=gtcolname)
