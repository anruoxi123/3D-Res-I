...
if __name__ == '__main__':
    annotations_filename = '/7T_DISK/mhq/3in1-D/evaluationScript/annotations/annotations.csv'
    annotations_excluded_filename = '/7T_DISK/mhq/3in1-D/evaluationScript/annotations/annotations_excluded.csv'
    seriesuids_filename = '/7T_DISK/mhq/3in1-D/evaluationScript/annotations/seriesuids_6.csv'
    results_filename = '/7T_DISK/mhq/3in1-D/detector/results/res18/retrft966/val87/predanno-2.csv'#3D Faster R-CNN - Res18.csv' #top5.csv'#
